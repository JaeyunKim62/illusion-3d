...
from eval.evaluate_image_triple_feasibility import capacity_stats, mask_stats, semantic_group
...
def main():
    ...
    p.add_argument("--output", default="data/image-triple-fast-ranking-20260601.json")
    args = p.parse_args()
